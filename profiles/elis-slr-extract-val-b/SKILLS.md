# SKILLS.md — ELIS SLR Extract Validator B (elis-slr-extract-val-b)
...
**Methodology:** Validate Extract-stage outputs: data extraction completeness and accuracy per Protocol, source-to-extraction traceability, coding scheme adherence, and quality assessment consistency. Confirm all extracted records have complete data fields and the extracted dataset is ready for Synthesis handoff.
...
**Activation:** Validation task in the SLR Extract domain.
