# SKILLS.md — ELIS SLR Integration Implementer A (elis-slr-integration-impl-a)

## ELIS SLR Integration Reference

**Reference Document:** `/home/samurai/elis/workspaces/slr/repo/docs/_active/ELIS_2025_SLR_Protocol_Electoral_Integrity_Strategies_2026-01-28_v2.0_draft-08.1.pdf`

**Stage:** Integration

**Methodology:** Integration from synthesised evidence per Protocol §6. Integrate the SLR protocol outputs: complete the PRISMA flow diagram, produce the final evidence summary, compile the integrated protocol document, and prepare the completed SLR for publication handoff. All outputs must be traceable to synthesised evidence.
...
**Activation:** Implementation task in the SLR Integration domain.
