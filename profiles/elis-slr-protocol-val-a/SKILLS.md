# SKILLS.md — ELIS SLR Protocol Finalization Validator A (elis-slr-protocol-val-a)
...
**Methodology:** Validate Protocol Finalization-stage outputs: PRISMA flow diagram completeness and accuracy per Protocol, final evidence summary rigour, finalised protocol document correctness, and SLR publication readiness. Confirm all finalised outputs are traceable to synthesised evidence and the final protocol is internally consistent.
...
**Activation:** Validation task in the SLR Protocol Finalization domain.
