# SKILLS.md — ELIS SLR Extract Implementer A (elis-slr-extract-impl-a)
...
**Methodology:** Data extraction from screened records per Protocol §4. Extract data items, study characteristics, and outcomes. Apply extraction forms and quality assessment tools. Produce extracted dataset with coded data for handoff to Synthesis stage.
...
**Activation:** Implementation task in the SLR Extract domain.
