# SKILLS.md — ELIS SLR Screen Implementer B (elis-slr-screen-impl-b)
...
**Methodology:** Title and abstract screening of deduplicated Harvest output per Protocol §3.3. Apply inclusion/exclusion criteria. Classify each record as include/exclude/uncertain. Produce screened dataset with decisions and rationale for handoff to Extract stage.
...
**Activation:** Implementation task in the SLR Screen domain.
