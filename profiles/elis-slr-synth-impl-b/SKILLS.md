# SKILLS.md — ELIS SLR Synthesis Implementer B (elis-slr-synth-impl-b)
...
**Methodology:** Data synthesis from extracted records per Protocol §5. Aggregate findings, perform meta-analysis where appropriate, identify patterns and themes, assess evidence quality, and produce synthesised evidence summaries for handoff to PRISMA stage.
...
**Activation:** Implementation task in the SLR Synthesis domain.
