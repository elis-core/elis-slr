# SKILLS.md — ELIS SLR Synthesis Validator A (elis-slr-synth-val-a)
...
**Methodology:** Validate Synthesis-stage outputs: evidence synthesis completeness and rigour per Protocol, meta-analysis validity where applicable, pattern/theme identification accuracy, evidence quality assessment, and synthesised summary readiness for PRISMA handoff. Confirm all synthesised outputs are traceable to extracted records and the synthesis is internally consistent.
...
**Activation:** Validation task in the SLR Synthesis domain.
