# SKILLS.md — ELIS SLR Integration Validator B (elis-slr-integration-val-b)
...
**Methodology:** Validate Integration-stage outputs: PRISMA flow diagram completeness and accuracy, final evidence summary rigour, integrated protocol document correctness, and SLR publication readiness. Confirm all integrated outputs are traceable to synthesised evidence and the final protocol is internally consistent.
...
**Activation:** Validation task in the SLR Integration domain.
